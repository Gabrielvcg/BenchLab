...
public class Implementation {
    ...
    public ImplementationLanguage getLanguage() { return language; }
    public void setLanguage(ImplementationLanguage language) { this.language = language; }
    public String getSourceCode() { return sourceCode; }
    public void setSourceCode(String sourceCode) { this.sourceCode = sourceCode; }
    public String getCompileConfig() { return compileConfig; }
    public void setCompileConfig(String compileConfig) { this.compileConfig = compileConfig; }
    ...
    public String getImplementationHash() { return implementationHash; }
    public void setImplementationHash(String implementationHash) { this.implementationHash = implementationHash; }
}
