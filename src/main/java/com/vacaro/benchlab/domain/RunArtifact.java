...
public class RunArtifact {
    ...
    private String stdoutTruncated;

    @Column(name = "stderr_truncated")
    private String stderrTruncated;
    ...
    public String getStdoutTruncated() { return stdoutTruncated; }
    public void setStdoutTruncated(String stdoutTruncated) { this.stdoutTruncated = stdoutTruncated; }
    public String getStderrTruncated() { return stderrTruncated; }
    public void setStderrTruncated(String stderrTruncated) { this.stderrTruncated = stderrTruncated; }
    ...
    public String getTechnicalLogSummary() { return technicalLogSummary; }
    public void setTechnicalLogSummary(String technicalLogSummary) { this.technicalLogSummary = technicalLogSummary; }
}
