...
public class RunArtifact {
    ...
    public Boolean getStdoutTruncated() { return stdoutTruncated; }
    public void setStdoutTruncated(Boolean stdoutTruncated) { this.stdoutTruncated = stdoutTruncated; }
    public Boolean getStderrTruncated() { return stderrTruncated; }
    public void setStderrTruncated(Boolean stderrTruncated) { this.stderrTruncated = stderrTruncated; }
