...
public interface BenchmarkRunRepository extends JpaRepository<BenchmarkRun, Long> {
    ...
    @EntityGraph(attributePaths = { "implementation", "implementation.algorithm", "dataset" })
    List<BenchmarkRun> findTop100ByRequestedByAndIdLessThanOrderByIdDesc(String requestedBy, Long beforeId);
    ...
    @Query(
        ...
        select
            ...
            metric.executionWallTimeMs as executionWallTimeMs,
    ...
    List<BenchmarkMetricSample> findComplexitySamples(@Param("algorithmId") Long algorithmId, @Param("status") BenchmarkRunStatus status);
}
